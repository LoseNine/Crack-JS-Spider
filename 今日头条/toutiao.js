...
window.location={
    "ancestorOrigins": {},
    "href": "https://www.toutiao.com/?wid=1642144415976",
...
function S(e, t) {
    var n, r;
    var a = "".concat(window.location.protocol, "//").concat(window.location.host);
    if (I(e))
        a += "/toutiao";
    if (false)
        ;var i = {
    ...
    if (t.data)
        i.body = t.data;
    var o = jsvmp.sign.call(n,i);
    return o
};

function test() {
    var e='/api/pc/list/feed?channel_id=0&max_behot_time=1642144972&category=pc_profile_recommend&aid=24&app_name=toutiao_web';
    var t={
